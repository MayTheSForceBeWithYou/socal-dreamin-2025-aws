...
echo "   python -m setup_tools salesforce setup-complete --contact-email your-email@example.com --environment demo"
echo ""
echo "2. Set up Terraform variables:"
echo "   python -m setup_tools infrastructure setup-terraform-vars --environment demo"
echo ""
...
echo "   python -m setup_tools infrastructure deploy-complete-lab --environment demo --validate"
echo ""
echo "📊 Access OpenSearch Dashboards"
echo "==============================="
echo "• Direct access: python -m setup_tools services access-dashboards --open-browser"
echo "• Proxy server: python -m setup_tools services start-dashboard-proxy"
echo "• SSH tunnel: ssh -i aws/certs/aws-ec2 -L 9200:localhost:9200 ec2-user@<EC2_IP>"
echo ""
echo "🔍 Validation & Testing"
echo "======================="
echo "• Comprehensive validation: python -m setup_tools validation validate-lab --comprehensive"
echo "• Generate test data: python -m setup_tools validation generate-test-data --count 100"
echo "• Check specific components: python -m setup_tools validation validate-lab --component opensearch"
echo ""
echo "🛠️ Individual Commands (if needed)"
echo "=================================="
echo "• AWS certificate: python -m setup_tools aws generate-certificate --key-name aws-ec2"
echo "• Salesforce certificate: python -m setup_tools salesforce generate-certificate"
echo "• Create scratch org: python -m setup_tools salesforce create-scratch-org --org-name demo --duration-days 30"
echo "• Setup Connected App: python -m setup_tools salesforce setup-connected-app --contact-email your-email@example.com"
echo "• Create integration user: python -m setup_tools salesforce create-integration-user --contact-email your-email@example.com"
echo "• Query login history: python -m setup_tools salesforce query-login-history"
echo ""
...
echo "• List all commands: python -m setup_tools list-commands"
echo "• Command help: python -m setup_tools command-info <command-name>"
echo ""
echo "🎯 Key Features Available:"
echo "• One-command deployment with validation"
echo "• Comprehensive setup_tools suite"
